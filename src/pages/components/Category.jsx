...
const Category = () => {
    ...
    console.log(index);
    //url 라우터에 의해 전달되는 값 http://localhost:3000/category/:index
    ...
    return (
        <>
            <section className="cate_banner" style={{ backgroundImage:`url(${brandBanner[index]})`}}>
                {/* <img src={bannerUrl} /> */}
            </section>
            <section className="cate_content-space">
                <div className="wrap">
                    <div className="title">
                        <h3 className="text-uppercase">{brandTitle[index]}</h3>
                    </div>
